          ...
          <VTable class="text-no-wrap">
            ...
            <thead>
              <tr>
                ...
                <th scope="col">
                  {{ languagePack.INVOICE_WITHDRAW_TOTAL_AMOUNT_VN }}( RECEIEVE )
                </th>
            ...
            <tbody>
              <tr v-for="order in lstTransactions" :key="order.transactionId">
                ...
                <td>
                  <span class="text-capitalize text-base text-small-txt"
                    >{{ formatUsdt(order.amount_usd - (order.amount_usd * fee) / 100) }}
                  </span>
                </td>
                <td>
                  <span class="text-capitalize text-base text-small-txt"
                ...
                <td>
                  <span v-if="order.address == null" class="text-capitalize text-base smail-bank"
